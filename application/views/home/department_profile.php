    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-xs-12 col col-md-12">
                <h4 style="margin-bottom: 2px;padding-bottom: 2px;border-bottom: 2px solid #009bdb; border-bottom-width: 1px;border-bottom-style: solid; border-bottom-color: rgb(206, 206, 206);"><span class="btn btn-secondary text-uppercase"><?php echo '' ?> Department</span></h4>
                <p>
                    ...
                    <?php foreach ($dept_info as $rows) { ?>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="bio-box">
                                ...
                                <div class="inner">
                                    <h5>Dr. <?php echo $rows->DOCTOR_NAME?></h5>
