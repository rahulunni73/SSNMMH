			...
			<div class="row">
					...
					<div class="profile-block">
						<div class="panel panel-profile">
							<div class="panel-heading">
								<img style="display: block;margin: auto;" src="<?php echo $IMG_PATH.'doctors/'.$doctor[0]->IMG_PATH ?>" alt="Doctor Profile Image" class="img-responsive img-center-xs">
								<h3 class="panel-title">Dr. <?php echo $doctor[0]->DOC_NAME; ?></h3>
								<p class="caption"><?php echo $doctor[0]->DEPT_NAME; ?></p>
							</div>
							<div class="panel-body my_word_wrap">
								<ul class="list-unstyled">
									<li class="row">
										<span class="col-sm-4 col-xs-12"><strong>Speciality</strong></span>
										<span class="col-sm-8 col-xs-12"><?php echo $doctor[0]->SPECIALIZATION; ?></span>
									</li>
									<li class="row">
										<span class="col-sm-4 col-xs-12"><strong>Education</strong></span>
										<span class="col-sm-8 col-xs-12"><?php echo $doctor[0]->QUALIFICATION; ?></span>
									</li>
									<li class="row">
										<span class="col-sm-4 col-xs-12"><strong>Work Days</strong></span>
										<span class="col-sm-8 col-xs-12"><?php echo $doctor[0]->OPDAYS; ?></span>
									</li>
								</ul>
							</div>
				...
				<div class="col-sm-7 col-xs-12">
					<div class="profile-details">
						<h3 class="main-heading2">Dr. <?php echo $doctor[0]->DOC_NAME; ?></h3>
						<h4>About</h4>
						<h5></h5>
						<p>
							Not available
