...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url(); ?>assets/css/dept_overlay.css" rel="stylesheet">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="navbar-collapse collapse">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="<?php
                                if (isset($about)){ echo $about;}?>"><a href="<?php echo site_url('home/about') ?>">About</a></li>
                                <li class="<?php if (isset($doct_active)) { echo $doct_active;}?>">
