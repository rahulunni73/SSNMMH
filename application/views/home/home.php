...
<section class="slider clearfix">
    <div id="camera_wrap_1" class="camera_wrap camera_white_skin">
        <!-- Slide #1 Starts -->
        <div data-src="<?php echo base_url(); ?>assets/images/slider/slider-img1.jpg">
            <div class="camera_caption fadeFromLeft hidden-sm hidden-xs">
                ...
                <a href="<?php echo site_url('home/services')?>" class="btn btn-secondary">View Services</a>
            </div>
        </div>
        <!-- Slide #1 Ends -->
        <!-- Slide #2 Starts -->
        <div data-src="<?php echo base_url(); ?>assets/images/slider/slider-img2.jpg">
        ...
        <!-- Slide #2 Ends -->
        <!-- Slide #3 Starts -->
        <div data-src="<?php echo base_url(); ?>assets/images/slider/slider-img3.jpg">
            <div class="camera_caption fadeIn hidden-sm hidden-xs">
                <h2>Main Heading</h2>
                <h2><span>Some Caption</span> Here</h2>
                <p>
    ...
    <div class="notification-boxes row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="box">
                ...
                <a href="<?php echo site_url('home/insurance')?>" class="btn btn-transparent">Read More</a>
            </div>
        </div>
        <!-- Box #4 Ends -->
    </div>
