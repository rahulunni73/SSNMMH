    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12 col-lg-6">
                <a class="users-list-name" href="<?php echo site_url('admin/dashboard/create_insurance'); ?>">
                    <div class="info-box">
                        <span class="info-box-icon bg-aqua"><i class="fa fa-plus"></i></span>
                        <div class="info-box-content">
                            <span class="info-box-text">Add Insurance Company</span>
                            <span class="text-muted">You add new one</span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                </a>
...
<!--            <div  class="col-md-3 col-sm-6 col-xs-12 col-lg-6">
            ...
            <!-- /.col -->
            <div class="col-md-3 col-sm-6 col-xs-12 col-lg-6">
                <a class="users-list-name" href="<?php echo site_url('admin/dashboard/remove_insurance'); ?>">
                    <div class="info-box">
                        <span class="info-box-icon bg-yellow"><i class="fa fa-trash-o"></i></span>

                        <div class="info-box-content">
                            <span class="info-box-text" >Remove Insurance Company</span>
                            <span class="text-muted">You can delete Insurance</span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                </a>
